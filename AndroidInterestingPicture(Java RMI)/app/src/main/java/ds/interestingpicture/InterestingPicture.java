...
public class InterestingPicture extends Activity {
    ...
    public void pictureReady(Bitmap picture) {
        ...
        TextView searchFeedback = (TextView)findViewById(R.id.feedback);
        String searchTerm = ((EditText)findViewById(R.id.searchTerm)).getText().toString();
		if (picture != null) {
    		pictureView.setImageBitmap(picture);
    		pictureView.setVisibility(View.VISIBLE);
            searchFeedback.setText("Succeed! Here is a picture of "+searchTerm);
    	} else {
    		pictureView.setImageResource(R.drawable.icon);
    		pictureView.setVisibility(View.INVISIBLE);
            searchFeedback.setText("Sorry, I could not find a picture of a "+searchTerm);
