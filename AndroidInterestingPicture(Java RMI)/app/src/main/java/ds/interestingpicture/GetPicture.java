...
public class GetPicture {
    ...
    private class AsyncFlickrSearch extends AsyncTask<String, Void, Bitmap> {
        ...
        private Bitmap search(String searchTerm) {        
    	      ...
    	      Document doc = getRemoteXML("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=e852260d514d3d63381be7a8e0ae6fc7&is_getty=true&tags="+searchTerm);
